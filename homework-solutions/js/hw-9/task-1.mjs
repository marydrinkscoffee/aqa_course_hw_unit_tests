...
// 2. Создать массив из значений объекта character 
// и присвоить его в переменную "stringValues" е, где тип данных строка //'Barney', 'male'
